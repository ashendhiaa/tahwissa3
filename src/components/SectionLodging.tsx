        ...
        {data.map((lodging: any, index: React.Key | null | undefined) => {
          return (
            <CardLodging
              ...
              img={`https://maps.googleapis.com/maps/api/place/photo?maxwidth=5480&photo_reference=${lodging.photos[0].photo_reference}&key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}`}
            />
          );
        })}
      </Slider>
